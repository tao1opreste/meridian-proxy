...
const DIGESTS = {
  smartmoney: {
    ttl: 7 * DAY_MS,
    system: 'Eres un analista que traduce las senales del dinero institucional para CUALQUIER persona, no solo expertos. Usas web_search para datos recientes y verificados. Regla de oro: cuando aparezca un concepto que un principiante no entienda (smart money, dark pool, short interest, options flow, insider...), explicalo en pocas palabras la primera vez. Tu valor es que se ENTIENDA y sea util, no soltar jerga ni datos sueltos. Devuelve SOLO JSON valido, sin markdown, sin emojis ni simbolos raros. En espanol de Espana.',
    prompt: `Rastrea las senales de "smart money" (el dinero de los grandes fondos e instituciones) mas recientes en el mercado de EE.UU.: 1) dark pool y block trades, 2) cambios en short interest, 3) insider buying/selling (compras y ventas de directivos), 4) options flow inusual.
MUY IMPORTANTE: que lo entienda alguien sin conocimientos. Para CADA senal, en el "detail": (a) explica en pocas palabras QUE ES ese concepto, (b) la senal concreta y reciente, (c) POR QUE importa o que suelen anticipar los grandes con eso. Lenguaje claro y a tierra; nada de jerga sin explicar, ni datos sueltos, ni obviedades.
Devuelve SOLO este JSON:
{"summary":"1-2 frases: explica brevemente que es el smart money (el dinero de los grandes) y la foto general ahora, en claro","items":[{"label":"Dark pool","detail":"que es un dark pool en pocas palabras + la senal reciente + por que importa"},{"label":"Short interest","detail":"que es + senal + por que"},{"label":"Insiders","detail":"que es + senal + por que"},{"label":"Options flow","detail":"que es + senal + por que"}],"asOf":"de cuando son los datos mas recientes que has usado","conclusion":"conclusion CLARA y aterrizada: que significa todo en conjunto y que vigilar, 2 frases"}
Texto en espanol claro, sencillo, explicando los conceptos, sin markdown, sin emojis ni simbolos raros.`,
  },
  '13f': {
    ttl: 21 * DAY_MS,
